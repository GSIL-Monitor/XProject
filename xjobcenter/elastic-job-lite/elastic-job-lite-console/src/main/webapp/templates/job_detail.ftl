...
<div>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li id="execution_log_tab" role="presentation"><a href="#execution_log" aria-controls="execution_log" role="tab" data-toggle="tab">作业日志</a></li>
    </ul>
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="execution_log">
            <div style="margin-top: 5px;">
                <label for="is-success">是否成功: </label>
                <select id="is-success" name="is-success">
