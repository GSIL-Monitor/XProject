...
public class ServerController {
    ...
    public Collection<ServerBriefInfo> getAllServersBriefInfo() {
        ...
        return jobAPIService.getServerStatisticsAPI(regCenterConfig).getAllServersBriefInfo();
    }
    ...
    public Collection<ServerInfo> getJobs(final ServerInfo jobServer, final ModelMap model) {
        ...
        return jobAPIService.getServerStatisticsAPI(regCenterConfig).getJobs(jobServer.getIp());
    }
}
