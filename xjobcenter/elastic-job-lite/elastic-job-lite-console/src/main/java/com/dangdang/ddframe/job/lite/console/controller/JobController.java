...
public class JobController {
    ...
    public Collection<JobBriefInfo> getAllJobsBriefInfo() {
        ...
        return jobAPIService.getJobStatisticsAPI(regCenterConfig).getAllJobsBriefInfo();
    }
    ...
    public Collection<ServerInfo> getServers(final ServerInfo jobServer) {
        ...
        return jobAPIService.getJobStatisticsAPI(regCenterConfig).getServers(jobServer.getJobName());
    }
    ...
    public Collection<ExecutionInfo> getExecutionInfo(final JobSettings jobSettings) {
        ...
        return jobAPIService.getJobStatisticsAPI(regCenterConfig).getExecutionInfo(jobSettings.getJobName());
    }
    ...
    public Map<String, Object> getLog(final String jobName, final String isSuccess, final Integer pageNo, final Integer pageSize) {
        return jobAPIService.getExecutionLogList(jobName, isSuccess, pageNo, pageSize);
    }
