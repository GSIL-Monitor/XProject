...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 form-body">
            <input id="uid" type="hidden" class="form-control" name="uid" value="<shiro:principal/>">
            <input id="o" type="hidden" class="form-control" name="o" value="${user.o}">
            ...
            <input type="button" class="btn btn-block" value="提 交" onclick="updatePassword();" />
